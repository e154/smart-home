...
|Ветка       |Статус   |
|------------|---------|
|master      | [![Статус сбоки](https://travis-ci.org/e154/smart-home.svg?branch=master)](https://travis-ci.org/e154/smart-home?branch=master)   |
|dev         | [![Статус сбоки](https://travis-ci.org/e154/smart-home.svg?branch=develop)](https://travis-ci.org/e154/smart-home?branch=develop) |
...
9. modbus, mqtt, [zigbee2mqtt](https://www.zigbee2mqtt.io/), вызов внешних программ и скриптов
