...
func (b *Core) InitNodes() (err error) {
	...
	for _, model_node := range nodes {
		b.AddNode(NewNode(model_node))
	}

	return
}

func (b *Core) AddNode(node *Node) (err error) {
...
func (b *Core) RemoveNode(node *Node) (err error) {
...
func (b *Core) ReloadNode(node *Node) (err error) {
...
func (b *Core) ConnectNode(node *Node) (err error) {
...
func (b *Core) DisconnectNode(node *Node) (err error) {
