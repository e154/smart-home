...
// GetMapById retrieves Map by Id. Returns error if
// Id doesn't exist
...
// GetAllMap retrieves all Map matches certain condition. Returns empty list if
// no records exist
...
// UpdateMap updates Map by Id and returns error if
...
func UpdateMapById(m *Map) (err error) {
	...
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Update(m, "Name", "Description", "Layers", "Options"); err == nil {
...
// DeleteMap deletes Map by Id and returns error if
...
func DeleteMap(id int64) (err error) {
	...
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&Map{Id: id}); err == nil {
