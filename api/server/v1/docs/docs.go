...
// 2019-03-10 19:31:11.251278 +0700 +07 m=+0.362785644
    ...
    "paths": {
        ...
        "/maps/search": {
            "get": {
                ...
                "description": "Search map_layer by name",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "models.FlowListModel": {
            ...
            "properties": {
                ...
                "workers": {
                    "type": "array",
                    "items": {
                        "type": "\u0026{%!s(token.Pos=316) %!s(*ast.FieldList=\u0026{323 [0xc000512ec0] 349}) %!s(bool=false)}"
                    }
                },
                "workflow": {
                    "type": "object",
