...
// 2019-03-08 17:16:56.247477 +0700 +07 m=+0.176848417
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "object",
                            "$ref": "#/definitions/models.SearchFlowResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized"
    ...
    "definitions": {
        ...
        "models.FlowListModel": {
            ...
            "properties": {
                ...
                "workers": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.FlowListWorkerModel"
                    }
                },
                "workflow": {
                    "type": "object",
                    "$ref": "#/definitions/models.FlowListModelWorkflow"
                }
            }
        },
        "models.FlowListModelWorkflow": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer"
        ...
        "models.NewFlowModel": {
            ...
            "properties": {
                ...
                "scenario": {
                    "type": "object",
                    "$ref": "#/definitions/models.NewFlowWorkflowScenarioModel"
                },
                "status": {
                    "type": "string"
                },
                "workflow": {
                    "type": "object",
                    "$ref": "#/definitions/models.NewFlowWorkflowModel"
                }
            }
        },
        "models.NewFlowWorkflowModel": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer"
        ...
        "models.NewFlowWorkflowScenarioModel": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer"
