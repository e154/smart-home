...
func (c *authServiceClient) Signin(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*SigninResponse, error) {
...
func _AuthService_Signin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).Signin(ctx, req.(*emptypb.Empty))
	}
...
func _AuthService_AccessList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(AuthServiceServer).AccessList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
