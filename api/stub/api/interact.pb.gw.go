...
func RegisterInteractServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server InteractServiceServer) error {
	...
	mux.Handle("POST", pattern_InteractService_EntityCallAction_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_InteractService_EntityCallAction_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_InteractService_EntityCallAction_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterInteractServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client InteractServiceClient) error {
	...
	mux.Handle("POST", pattern_InteractService_EntityCallAction_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_InteractService_EntityCallAction_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
