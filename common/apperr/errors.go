...
var (
	...
	ErrActionGet      = New("failed to get action", ErrAreaNotFound)
	...
	ErrConditionGet      = New("failed to get condition", ErrAreaNotFound)
	...
	ErrTriggerGet      = New("failed to get trigger", ErrAreaNotFound)
