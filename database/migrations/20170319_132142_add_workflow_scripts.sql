...
ALTER TABLE `workflow_scripts` ADD CONSTRAINT `lnk_scripts_workflow_scripts` FOREIGN KEY ( `script_id` ) REFERENCES `scripts`( `id` ) ON DELETE Restrict ON UPDATE Cascade;
ALTER TABLE `workflow_scripts` ADD CONSTRAINT `lnk_workflows_workflow_scripts` FOREIGN KEY ( `workflow_id` ) REFERENCES `workflows`( `id` ) ON DELETE Restrict ON UPDATE Cascade;
