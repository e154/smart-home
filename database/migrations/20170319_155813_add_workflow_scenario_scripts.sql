...
ALTER TABLE `workflow_scenario_scripts` ADD CONSTRAINT `lnk_workflow_scenarios_workflow_scenario_scripts` FOREIGN KEY (`workflow_scenario_id`) REFERENCES `workflow_scenarios` (`id`)  ON UPDATE CASCADE;
