...
func (r DashboardCard) UpdateDashboardCard(obj *stub.DashboardCardServiceUpdateDashboardCardJSONBody, id int64) (ver *models.DashboardCard) {
	ver = &models.DashboardCard{
		Id:             id,
		Title:          obj.Title,
		Height:         int(obj.Height),
		...
		DashboardTabId: obj.DashboardTabId,
		Payload:        obj.Payload,
		Items:          make([]*models.DashboardCardItem, 0, len(obj.Items)),
	}
	if obj.EntityId != nil && *obj.EntityId != "" {
		ver.EntityId = common.NewEntityId(*obj.EntityId)
	}
