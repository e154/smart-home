...
func (r DashboardTab) UpdateDashboardTab(obj *stub.DashboardTabServiceUpdateDashboardTabJSONBody, id int64) (ver *models.DashboardTab) {
	ver = &models.DashboardTab{
		Id:          id,
		Name:        obj.Name,
		Icon:        obj.Icon,
...
func ImportDashboardTab(obj *stub.ApiDashboardTab) (ver *models.DashboardTab) {
	ver = &models.DashboardTab{
		...
		DashboardId: obj.DashboardId,
		Payload:     obj.Payload,
		Cards:       make([]*models.DashboardCard, 0, len(obj.Cards)),
	}
