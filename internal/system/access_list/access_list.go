...
type AccessListService interface {
	...
	GetShotAccessList(ctx context.Context, role *models.Role) (err error)
...
// GetShotAccessList ...
func (a *accessListService) GetShotAccessList(ctx context.Context, role *models.Role) (err error) {
