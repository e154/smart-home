...
func (c *Common) addPlugin(ctx context.Context, name string, enabled, system, actor bool, version string) error {
	return c.adaptors.Plugin.CreateOrUpdate(ctx, &models.Plugin{
		Name:    name,
		Version: version,
		Enabled: enabled,
		System:  system,
...
func (s *Common) addScript(ctx context.Context, name, source, desc string) (script *models.Script, err error) {
