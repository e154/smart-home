...
var (
	...
	ErrEntityImport       = ErrorWithCode("ENTITY_IMPORT_ERROR", "failed to import entity", ErrInternal)
	...
	ErrVariableCreateOrUpdate  = ErrorWithCode("VARIABLE_ADD_OR_UPDATE_ERROR", "failed to add or update variable", ErrInternal)
