...
// GetScriptById retrieves Script by Id. Returns error if
// Id doesn't exist
...
// GetAllScript retrieves all Script matches certain condition. Returns empty list if
// no records exist
...
// UpdateScript updates Script by Id and returns error if
...
// DeleteScript deletes Script by Id and returns error if
