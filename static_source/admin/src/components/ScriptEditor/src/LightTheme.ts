const
    ...
    highlightBackground = "rgba(143,141,141,0.45)",
    background = "#f8f8f8",
    tooltipBackground = "#f8f8f8",
    selection = "rgba(0,119,170,0.49)",
    cursor = "#000"
...
const lightTheme = {
    ...
    ".cm-panels": {backgroundColor: background, color: v4},
    ".cm-panels.cm-panels-top": {borderBottom: "2px solid background"},
    ".cm-panels.cm-panels-bottom": {borderTop: "2px solid background"},
