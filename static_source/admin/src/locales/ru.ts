export default {
  ...
  scripts: {
    ...
    entityActions: "Действия Entity",
    entityScripts: "Скрипты Entity",
    ...
    info4: 'Поиск будет происходить как в названии файла, так и в коде',
  ...
  entities: {
    ...
    restoreState: 'Восстонавливать состояние после перезагрузки',
    main: "Основное",
    actions: "Действия",
    states: "Состояния",
    attributes: "Атрибуты",
    ...
    currentState: "Текущее состояние",
    import: "Импорт",
    dialogImportTitle: "Импорт Entity",
    dialogExportTitle: "Экспорт Entity",
  ...
  dashboard: {
    ...
    pasteCardItem: 'Вставить элемент',
    mainTab: "Основные настройки",
    tabsTab: "Вкладки",
    tabOptions: 'Опции вкладки',
    cardOptions: 'Опции карты',
    cardItemOptions: 'Опции элемента',
    cardsTab: "Карточки",
    cardItemsTab: "Элементы",
    mainSettings: "Базовые Настройки",
    tabDetail: 'Свойства вкладки',
    cardDetail: 'Свойства карточки',
    enabled: "Включено",
    area: "Область",
    ...
    noTabs: "пусто",
    addNew: "Добавить",
    addNewTab: "Добавить вкладку",
    addNewCard: "Добавить карточку",
    importCard: "Импорт",
    title: "Заголовок",
    hidden: "Скрыто",
    height: "Высота",
    ...
    editor: {
      ...
      imageCropX: 'X',
      imageCropY: 'Y',
      imageCropHeight: 'Высота',
      imageCropWidth: 'Ширина',
      imageCropInfo: 'Информация',
      refresh: 'Обновить',
      rotateLeft: 'Повернуть против часово',
      rotateRight: 'Повернуть по часовой',
      swapX: 'Перевернуть по горизонтали',
      swapY: 'Перевернуть по вертикали',
      zoomIn: 'Приблизить',
      zoomOut: 'Отдалить',
      clear: 'Очистить',
      FontsOptions: 'Шрифты',
      ...
      chart: {
        ...
        chartDocumentation: 'Chart Документация',
  ...
  settings: {
    ...
    info4: 'Для работы Service Worker и Web Push API Все веб-страницы и ресурсы системы управления должны быть доступны через HTTPS, то есть защищены SSL-сертификатом.\n Это важно для обеспечения безопасности передачи данных между сервером и клиентом.',
    ...
    certPublic: 'Выберите файл сертификата X.509, обычно это файл crt, cer или pem.',
    certKey: 'Выберите файл закрытого ключа, обычно ключ или pem-файл.'
  },
  tools: {
    eventBus: {
      topic: 'Канал',
